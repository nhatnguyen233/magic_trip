                ...
                <div class="row no-gutters custom-search-input-2">
                    ...
                    <div class="col-lg-3">
                        <select class="wide" name="cat_id">
                            ...
                            <option value="{{ $category->id }}" @if(request()->get('cat_id') == $category->id) selected @endif>
                                {{ $category->name }}
                            </option>
                            @endforeach
                        </select>
    ...
    <div id="reccomended" class="owl-carousel owl-theme">
        ...
        <div class="item">
            <div class="box_grid">
                <figure>
                    ...
                    <a href="{{ route('tours.show', $item->id) }}"><img src="{{ $item->thumbnail_url }}" class="img-fluid" alt="" width="800" height="533">
        ...
        <div class="item">
            <div class="box_grid">
                <figure>
                    <a href="#0" class="wish_bt"></a>
                    <a href="tour-detail.html"><img src="{{ asset('img/tour_1.jpg') }}" class="img-fluid" alt="" width="800" height="533">
        ...
        <div class="item">
            <div class="box_grid">
                <figure>
                    <a href="#0" class="wish_bt"></a>
                    <a href="tour-detail.html"><img src="{{ asset('img/tour_2.jpg') }}" class="img-fluid" alt="" width="800" height="533">
                        <div class="read_more"><span>Read more</span></div>
                    </a>
        ...
        <div class="item">
            <div class="box_grid">
                <figure>
                    <a href="#0" class="wish_bt"></a>
                    <a href="tour-detail.html"><img src="{{ asset('img/tour_3.jpg') }}" class="img-fluid" alt="" width="800" height="533">
                        <div class="read_more"><span>Read more</span></div>
                    </a>
                    <small>Historic</small>
                </figure>
...
<div class="container container-custom margin_30_95">
    <section class="add_bottom_45">
        ...
        <!-- /row -->
        <a href="{{ route('accommodations.index') }}"><strong>@lang('message.all') ({{ $accommodations->count() }}) <i class="arrow_carrot-right"></i></strong></a>
    </section>
    <!-- /section -->
    ...
    <section class="add_bottom_45">
        ...
        <!-- /row -->
        <a href="{{ route('attractions.index') }}"><strong>@lang('message.all') ({{ $attractions->count() }}) <i class="arrow_carrot-right"></i></strong></a>
    </section>
    <!-- /section -->
...
<div class="bg_color_1">
    <div class="container margin_80_55">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <a class="box_news" href="{{ route('events.show', $item->id) }}">
                    <figure><img src="{{ $item->AvatarUrl }}" alt="">
                        <figcaption><strong>$item->created_at</strong>Dec</figcaption>
                    </figure>
                    <ul>
                        <li>{{ $item->author }}</li>
                        <li>{{ $item->updated_at }}</li>
                    </ul>
                    <h4>{{ Str::limit($item->title, 200)  }}</h4>
