                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nguyễn Văn A"
                               name="name" id="name" value="{{ isset($user->name) ? $user->name : '' }}" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="abc@example.com"
                               name="email" id="email" value="{{ isset($user->email) ? $user->email : '' }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="postal_code"
                               id="zipcode-attraction" value="{{ isset($user->postal_code) ? $user->postal_code : '' }}" />
                    </div>
                </div>
            </div>
            <!-- /row-->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="address" id="address-attraction"
                               placeholder="An Khánh, Hoài Đức, Hà Nội..." value="{{ isset($user->address) ? $user->address : '' }}" />
                    </div>
                </div>
            </div>
        </div>
