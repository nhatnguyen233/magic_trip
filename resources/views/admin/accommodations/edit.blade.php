...
@section('content')
    ...
    @endif
    <form action="{{ route('admin.accommodations.update', $accommodation->id) }}" method="post" enctype="multipart/form-data">
        @method('PUT')
        @csrf
    ...
    @include('admin.accommodations.modals._remove_album_image_modal')
@endsection
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click', '#removeImage', function () {
            var id = $(this).data('id');
            var url = window.location.origin + '/admincp/accommodation-images/' + id;
