...
@section('content')
    ...
    @endif
    <form action="{{ route('host.attractions.store') }}" method="post" enctype="multipart/form-data">
        @csrf
    ...
    @include('host.attractions.modals._crop_avatar_modal')
    @include('host.attractions.modals._crop_thumbnail_modal')
@endsection
