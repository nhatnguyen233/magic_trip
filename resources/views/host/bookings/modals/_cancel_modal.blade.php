<!-- Cancel Modal-->
<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="cancelLabel"
     aria-hidden="true">
        ...
        <form action="" method="POST" id="form-cancel">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="cancelLabel">Bạn chắc chắn hủy chấp nhận lịch book này?</h5>
