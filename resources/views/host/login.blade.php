...
<div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
    <div class="card card0 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"><img src="{{ asset('img/logo.svg') }}" class="logo"></div>
                    ...
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row mb-4 px-3">
                            <small class="font-weight-bold">Bạn chưa có tài khoản?
                                <a class="text-danger" href="{{ route('host.register.form') }}">Đăng ký</a>
                            </small>
                        </div>
                    </div>
                </form>
        ...
        <div class="bg-blue py-4">
            <div class="row px-3"><small class="ml-4 ml-sm-5 mb-2">All rights reserved.</small>
