                ...
                <form method="POST" action="{{ route('user.update-profile', $user) }}" enctype="multipart/form-data">
                        ...
                        <div class="box_cart">
                            <div class="message">
                                ...
                                <p>Cập nhật mật khẩu mới? <a href="#0">Quên mật khẩu</a></p>
                            </div>
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <div class="avatar-upload">
                                        <label for="avatar" class="w-100" style="border: 5px solid #fff; border-radius: 50%; box-shadow: 0 0 5px #646464c7; cursor: pointer">
                                            <img src="{{ !empty($user->getAvatarUrlAttribute()) ? asset($user->getAvatarUrlAttribute()) : ''  }}" width="140px" height="140px" class="rounded-circle" id="avatar-image" />
                                        </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" id="show_hide_password">
                                                <input type="password" class="form-control" name="password" id="passwordInput"
                                                       value="{{ isset($user->password) ? $user->password : '' }}" placeholder="Mật khẩu" required />
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" id="show_hide_confirm_password">
                                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" value="{{ isset($user->password) ? $user->password : '' }}" placeholder="Nhập lại mật khẩu" required />
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <a href="#"><i class="fa fa-eye-slash" aria-hidden="true"></i></a>
                                                    </div>
