...
class AccommodationController extends Controller
{
    ...
    {
        $accommodations = $this->accommodationRepository->findWhere(['user_id' => auth('host')->id()]);
    ...
    public function create()
    {
        ...
        return view('host.accommodations.create', $viewData);
    }
    ...
    public function store(Create $request)
    {
        ...
        if($request->images)
        {
            $this->accommodationRepository->insertAccommodationImages($request->images, $accommodation->id, auth('host')->id());
        }

        return redirect()->route('host.accommodations.index')->with('success', 'Tạo nơi nghỉ thành công');
    }
    ...
    public function edit(Accommodation $accommodation)
    {
        ...
        return view('host.accommodations.edit', $viewData);
    }
    ...
    public function update(Request $request, Accommodation $accommodation)
    {
        ...
        return redirect()->route('host.accommodations.index')->with('success', 'Cập nhật nơi nghỉ thành công');
    }
